  ...
  <nav class="bg-sidebar p-5">
    <div class="flex items-center justify-between">
      ...
      <div class="hidden items-center gap-4 md:flex">
        ...
        <button
          @click="toggleTheme"
          class="border-border hover:bg-border/20 flex h-10 w-20 items-center rounded-full border bg-transparent p-1 transition-colors"
          :aria-label="isDark ? 'Switch to light mode' : 'Switch to dark mode'"
        >
          <div
            class="bg-primary flex h-8 w-8 items-center justify-center rounded-full transition-transform duration-200"
        ...
        <Button class="text-md font-semibold">Sign Up</Button>
      </div>
