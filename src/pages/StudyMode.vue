  ...
  <AppLayout>
    ...
    >
      ...
      >
        ...
        <div class="relative z-10 my-4 mb-20 flex w-full justify-center px-4 sm:my-6">
          <Button
            @click="shuffle"
            variant="secondary"
            size="default"
        ...
        <div
          class="coverflow-container pointer-events-none mx-auto mt-42 w-full max-w-7xl flex-1 sm:mt-5 md:pointer-events-auto"
        >
          <div
            v-for="(card, index) in flashcards"
            :key="card.flashcard_id"
            class="coverflow-item pointer-events-auto"
            :style="{
              transform: `
        ...
        <div
          class="relative z-10 mt-25 grid w-full max-w-md grid-cols-3 items-center gap-3 px-4 pb-4 sm:mt-8 sm:gap-4 sm:pb-6"
        >
          <Button
            @click="prev"
            size="lg"
